      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-primary-orange hover:bg-opacity-90 text-primary-dark font-bold py-4 px-6 rounded-2xl transition-all duration-200 transform hover:scale-105 hover:shadow-lg text-lg tracking-wide"
          >
            NEW GAME (VS CPU)
          </button>
          ...
          <button
            ...
            className="w-full bg-primary-teal hover:bg-opacity-90 text-primary-dark font-bold py-4 px-6 rounded-2xl transition-all duration-200 transform hover:scale-105 hover:shadow-lg text-lg tracking-wide"
          >
            NEW GAME (VS PLAYER)
          </button>
        </div>
